...
require(["gitbook", "jQuery"], function (gitbook, $) {
  function resetViewCount(app_id, app_key) {
  ...
  var Counter = function (method, url, data) {
    return $.ajax({
      method: method,
      url: `https://y6mktrrq.api.lncld.net/1.1${url}`,
      headers: {
        'X-LC-Id': "Y6MkTRrqNxAvrSpXzlhIjkey-gzGzoHsz",
        'X-LC-Key': "1bq1iVlem18QoONqshpbjVB7",
        'Content-Type': 'application/json',
        },
      data: data,
    });
  ...
  gitbook.events.bind("page.change", resetViewCount(app_id, app_key))
});
